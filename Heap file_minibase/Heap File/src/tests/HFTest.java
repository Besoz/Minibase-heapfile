...
public boolean runTests () {
  ...
  protected boolean test6 () {
	  System.out.println ("\n  Test 6: Test deleting a file\n");
	  Heapfile hf = null;
	  try {
		hf=new Heapfile("file_1");
	} catch (FileIOException | InvalidPageNumberException | DiskMgrException
			...
			| DuplicateEntryException | OutOfSpaceException | IOException e) {
	...
	try {
		if (SystemDefs.JavabaseDB.get_file_entry("file_1")==null){
			System.out.println("  -->file deleted secsseffully\n");
		}
		else{
		       System.out.println ("  Test 6 failed badly.\n");
		       return false;
		}
	} catch (FileIOException | InvalidPageNumberException | DiskMgrException
			| IOException e) {
